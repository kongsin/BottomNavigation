...
public class BottomNavigationBar extends FrameLayout {
    ...
    protected static final int FAB_BEHAVIOUR_TRANSLATE_AND_STICK = 0;
    protected static final int FAB_BEHAVIOUR_DISAPPEAR = 1;
    protected static final int FAB_BEHAVIOUR_TRANSLATE_OUT = 2;
    ...
    protected static final Interpolator INTERPOLATOR = new LinearOutSlowInInterpolator();
    protected ViewPropertyAnimatorCompat mTranslationAnimator;
    ...
    protected ArrayList<BottomNavigationItem> mBottomNavigationItems = new ArrayList<>();
    protected ArrayList<BottomNavigationTab> mBottomNavigationTabs = new ArrayList<>();

    protected static final int DEFAULT_SELECTED_POSITION = -1;
    protected int mSelectedPosition = DEFAULT_SELECTED_POSITION;
    protected int mFirstSelectedPosition = 0;
    ...
    protected int mRippleAnimationDuration = (int) (DEFAULT_ANIMATION_DURATION * 2.5);

    protected float mElevation;

    protected boolean mAutoHideEnabled;
